...
menu = ["Exit", "List movies", "Add movie", "Delete movie", "Update movie", "Stats", "Random movie", "Search movie", "Movies Sorted by Rating"]
...
while True:
  ...
  for index, item in enumerate(menu):
    print(index, item)
  user_choice = int(input("\033[1;36m Enter choice (0-8):\n"))
